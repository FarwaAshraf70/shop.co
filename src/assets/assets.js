...
import bluejeans from "./bluejeans.png";
import chekshirt from "./chekshirt.png";
import orange from "./orange.png";
import gradient from "./gradient.png";
import polo from "./polo.png";
import blackstripped from "./blackstripped.png";
import vertical from "./vertical.png";
import courage from "./courage.png";
...
export const products = [
  {
    id: 1,
    image: blackshirt,
    images: [blackshirt, blackshirt, blackshirt, blackshirt],
...

  {
    id: 2,
    image: bluejeans,
    images: [bluejeans, bluejeans, bluejeans, bluejeans],
...

  {
    id: 3,
    image: chekshirt,
    images: [chekshirt, chekshirt, chekshirt, chekshirt],
...

  {
    id: 4,
    image: orange,
    images: [orange, orange, orange, orange],
...
export const productsOnSale = [
  ...
  //   category: "Men",
  //   size: ["28", "30", "32", "34", "36"],
  //   color: ["khaki", "navy", "gray"],
  //   style: "Formal",
  // },
];
// const categories = ["Men", "Women", "Kids", "Casual", "Formal", "Sports"];
